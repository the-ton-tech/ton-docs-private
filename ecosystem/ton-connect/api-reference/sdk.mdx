...
| Parameter | Type                                                               | Description                                                                                          |
| --------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- |
| `network` | [`ChainId`](/ecosystem/ton-connect/api-reference/protocol#chainid) | _Optional_. Desired network id (e.g., '-239', '-3', or custom). Pass undefined to allow any network. |
...
| Field                        | Type                              | Description                                                                                                                                                                                                                                                                           |
| ---------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `manifestUrl`                | `string`                          | _Optional_. URL to the [manifest](https://github.com/ton-connect/docs/blob/main/requests-responses.md#app-manifest) with the dApp metadata that the wallet displays to the user. If not passed, the SDK loads the manifest from `${window.location.origin}/tonconnect-manifest.json`. |
...
| `platforms`     | `('ios' \| 'android' \| 'macos' \| 'windows' \| 'linux' \| 'chrome' \| 'firefox' \| 'safari')[]` | OS and browsers where the wallet could be installed                                                                                                               |
| `universalLink` | `string`                                                                                         | Base part of the wallet universal url. The link should support [Ton Connect parameters](https://github.com/ton-connect/docs/blob/main/bridge.md#universal-link).  |
| `deepLink`      | `string`                                                                                         | _Optional_. Native wallet app deepLink. The link should support [Ton Connect parameters](https://github.com/ton-connect/docs/blob/main/bridge.md#universal-link). |
| `bridgeUrl`     | `string`                                                                                         | URL of the wallet's implementation of the [HTTP bridge](https://github.com/ton-connect/docs/blob/main/bridge.md#http-bridge).                                     |
...
| `testOnly`   | `boolean` | _Optional_. Convert address to test-only form. [See details](https://ton.org/docs/learn/overviews/addresses#user-friendly-address) Defaults to `false`. |
