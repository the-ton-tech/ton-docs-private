...
| `uiPreferences`            | [`UIPreferences`](/ecosystem/ton-connect/api-reference/ui#uipreferences)                       | _Optional_. UI elements configuration.                                                                                                                                            |
| `walletsListConfiguration` | [`WalletsListConfiguration`](/ecosystem/ton-connect/api-reference/ui#walletslistconfiguration) | _Optional_. Configuration for the wallets list in the connect wallet modal.                                                                                                       |
| `walletsRequiredFeatures`  | [`RequiredFeatures`](/ecosystem/ton-connect/api-reference/sdk#requiredfeatures)                | _Optional_. Required features for wallets to be displayed in the connect wallet modal.                                                                                            |
| `walletsPreferredFeatures` | [`RequiredFeatures`](/ecosystem/ton-connect/api-reference/sdk#requiredfeatures)                | _Optional_. Preferred features for wallets to be displayed in the connect wallet modal.                                                                                           |
| `actionsConfiguration`     | [`ActionConfiguration`](/ecosystem/ton-connect/api-reference/ui#actionconfiguration)           | _Optional_. Configuration for action-period (e.g. sendTransaction) UI elements: modals and notifications and wallet behaviour (return strategy).                                  |
...
| Parameter | Type           | Description                                                                                                                                                                                                                        |
| --------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `message` | `string`       | _Optional_. Human-readable message. The resulting `error.message` is prefixed with `[TON_CONNECT_SDK_ERROR]` and the subclass name (inherited from [`TonConnectError`](/ecosystem/ton-connect/api-reference/sdk#tonconnecterror)). |
