...
Unstake mechanics — instant, delayed, or round-end — are provider-specific. The bundled staking provider is Tonstakers. See [Staking](/ecosystem/appkit/concepts/staking) for the full flow.
...
For the install commands and code, see [Get Started > Providers](/ecosystem/appkit/get-started/providers).
