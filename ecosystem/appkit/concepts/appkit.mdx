...
- **Web2 apps** that need TON for authorization, payments, NFT rewards, or other common needs.
- **Web3 apps** that need to integrate TON wallets.
- **Telegram Mini Apps** that use TON Blockchain to provide services for Telegram users.
...
A few configuration knobs are worth knowing about up front:
