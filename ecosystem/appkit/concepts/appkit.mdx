...
Get a mainnet API key from [t.me/toncenter](https://t.me/toncenter) to access higher rate limits. Asset reads issue many requests; without a key, expect frequent 429 responses. See the full setup on the [Installation page](/ecosystem/appkit/get-started/installation).
