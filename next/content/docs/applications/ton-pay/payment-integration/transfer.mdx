...
<Steps>
  ...
  >
    - Use testnet wallet account: [Tonkeeper](/overview/wallets/tonkeeper) or other TON wallets.
    - [Get testnet TON](/overview/wallets/get-coins) from a faucet to test transactions.
  </Step>
