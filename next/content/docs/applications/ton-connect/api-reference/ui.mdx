...
| `options` | `ActionOptions<SendTransactionResponse>` | *Optional*. Modal and notifications behavior settings. Default shows only the 'before' modal and all notifications. |
...
| `options` | `ActionOptions<SignDataResponse>` | *Optional*. Modal and notifications behavior settings. |
...
| `options` | `ActionOptions<SignMessageResponse>` | *Optional*. Modal and notifications behavior settings. |
...
| `actionsConfiguration` | `ActionConfiguration` | *Optional*. Configuration for action-period (e.g. sendTransaction) UI elements: modals and notifications and wallet behavior (return strategy). |
