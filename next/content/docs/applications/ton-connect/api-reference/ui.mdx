...
| `options` | `ActionOptions<SendTransactionResponse>`                                                       | _Optional_. Modal and notifications behaviour settings. Default shows only the 'before' modal and all notifications. |
...
| `options` | `ActionOptions<SignDataResponse>`                                                     | _Optional_. Modal and notifications behaviour settings. |
...
| `options` | `ActionOptions<SignMessageResponse>`                                                   | _Optional_. Modal and notifications behaviour settings.           |
...
| `actionsConfiguration`     | `ActionConfiguration`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | _Optional_. Configuration for action-period (e.g. sendTransaction) UI elements: modals and notifications and wallet behaviour (return strategy).                                                                                                                          |
