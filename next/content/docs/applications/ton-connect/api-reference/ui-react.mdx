...
| `actionsConfiguration` | [`ActionConfiguration`](/applications/ton-connect/api-reference/ui#actionconfiguration) | *Optional*. Configuration for action-period (e.g. sendTransaction) UI elements: modals and notifications and wallet behavior (return strategy). |
