...
<Tree>
  ...
  >
    ...
    <Tree.File
      name="jetton-utils.tolk"
    />

    <Tree.File
      name="jetton-minter-contract.tolk"
    />

    <Tree.File
      name="jetton-wallet-contract.tolk"
    />
  </Tree.Folder>
</Tree>
...
<Tree>
  ...
  >
    ...
    <Tree.File
      name="nft-collection-contract.tolk"
    />

    <Tree.File
      name="nft-item-contract.tolk"
    />
  </Tree.Folder>
</Tree>
