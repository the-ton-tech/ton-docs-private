...
<Tree>
  <Tree.Folder name="contracts" defaultOpen>
    <Tree.File name="MyContract.{tolk|fc|tact}">Contract source code</Tree.File>
  </Tree.Folder>
  <Tree.Folder name="wrappers" defaultOpen>
    <Tree.File name="MyContract.ts">TypeScript wrapper for contract interaction</Tree.File>
  </Tree.Folder>
  <Tree.Folder name="tests" defaultOpen>
    <Tree.File name="MyContract.spec.ts">Jest test suite with basic test cases</Tree.File>
  </Tree.Folder>
  <Tree.Folder name="scripts" defaultOpen>
    <Tree.File name="deployMyContract.ts">Deployment script with network configuration</Tree.File>
  </Tree.Folder>
</Tree>
