...
<FileTree
  items={[{
    ...
    items: [{
      name: "MyContract.ts",
      kind: "file",
      note: "TypeScript wrapper for contract interaction"
    }]
  }, {
    name: "tests",
    kind: "folder",
    items: [{
      name: "MyContract.spec.ts",
      kind: "file",
      note: "Jest test suite with basic test cases"
    }]
  }, {
    name: "scripts",
    kind: "folder",
    items: [{
      name: "deployMyContract.ts",
      kind: "file",
      note: "deployment script with network configuration"
    }]
  }]}
/>
