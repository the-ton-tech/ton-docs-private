...
- Installed [TON wallet](/overview/wallets/tonkeeper) with [Toncoin on testnet](/overview/wallets/get-coins)
    ...
    <Tree>
      ...
      >
        ...
        <Tree.Folder
          ...
          defaultOpen
        >
          Deployment and on-chain interaction scripts
          <Tree.File name="deployFirstContract.ts">Script to deploy the contract</Tree.File>
        </Tree.Folder>
        ...
        >
          ...
          <Tree.File name="FirstContract.spec.ts">Contract test file</Tree.File>
        </Tree.Folder>
...
<Steps>
  ...
  >
    <Aside
      ...
      type="note"
    >
      If a wallet is not installed, check the [wallet section](/overview/wallets/tonkeeper) to select and install a wallet before deploying the contract. Make sure the wallet is funded with [Toncoin on the testnet](/overview/wallets/get-coins).
    </Aside>
