...
<Steps>
  ...
  >
    ...
    The link opens the contract on [Tonviewer](/overview/infrastructure/explorers/tonviewer), a [blockchain explorer](/overview/infrastructure/explorers/overview) showing transactions, messages and [account states](/foundations/status).
