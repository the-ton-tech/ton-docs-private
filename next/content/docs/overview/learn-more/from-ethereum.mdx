...
[The limit](/foundations/config) for contract storage is 65,536 unique cells contract storage, where a cell [stores up to](/blockchain-basics/primitives/serialization/cells) 1,023 bits. Messages are constrained by two size limits: 8,192 cells or 2<sup>21</sup> bits among them, whichever is smaller.
