...
The recommended way to create and use agentic wallets is through [`@ton/mcp`](/overview/ai/mcp). The [`@ton/mcp` quick start](/overview/ai/quick-start) guide covers the full setup flow and gives common usage examples.
