...
<Aside>
  The server starts in the agentic wallets mode by default. Alternatively, you can use the [single-wallet mode](/overview/ai/mcp#single-wallet-mode).
</Aside>
...
To learn more about TON MCP server and ways to use it, see [@ton/mcp](/overview/ai/mcp).
To learn more about agentic wallets, see [Agentic wallets](/overview/ai/wallets).
