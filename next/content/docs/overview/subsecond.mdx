...
- For the standard faucet, up to 2 TON per hour, [use Telegram Testgiver TON bot](/overview/wallets/get-coins#how-to-get-coins-on-testnet).
- For larger allocations up to 5,000 TON, [use the request form](/overview/wallets/get-coins#use-request-form).
